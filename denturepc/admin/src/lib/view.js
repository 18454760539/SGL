...
layui.define(['laytpl', 'layer'], function(exports){
  ...
  view.req = function(options){
    ...
    delete options.error;
      ...
      ,success: function(res){
        ...
        if (res[response.statusName] == statusCode.ok || res[response.statusName] == 1 || res[response.statusName] == 2) {
        ...
        var error = [
            ...
            , debug()
            +'<br><cite style="color:red;">请将弹窗截图给牙谷客服</cite>'
              ].join('');
  ...
  view.popup = function(options){
    ...
    return layer.open($.extend({
      type: 1
        , title: '<i class= "layui-icon" style = "font-size: 30px;float:left;color:red">&#xe702;</i>&nbsp;&nbsp;警告'
      , content: ''
