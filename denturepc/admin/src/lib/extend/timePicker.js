...
layui.define(['laydate','jquery',['moment']],function (exports) {
    ...
    timePicker.prototype.render = function (opt) {
        ...
        elem.on('click',function (e) {
            ...
            var timeDiv = '<div class="timePicker layui-anim layui-anim-upbit" style="left:' + l + ';top:' + t + ';z-index: 1000;">';
                timeDiv +='<div class="time-div">' +
                    ...
                    '<ul class="time-year"><span>时间</span><li><input type="radio" name="day"  value="16">近三天</li><li><input type="radio" name="day"  value="17">近十天</li><li><input type="radio" name="day"  value="18">近十五天</li></ul>' +
                    '<ul class="time-year"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><li><input type="radio" name="day"  value="19">近一周</li><li><input type="radio" name="day"  value="20">近两周</li><li><input type="radio" name="day"  value="21">近三周</li></ul>' +
                    '<ul class="time-year"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><li><input type="radio" name="day"  value="22">近一月</li><li><input type="radio" name="day"  value="23">近两月</li><li><input type="radio" name="day"  value="24">近三月</li></ul>' +
                    '<ul class="time-year"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><li><input type="radio" name="day"  value="25">近半年</li><li><input type="radio" name="day"  value="26">近一年</li><li><input type="radio" name="day"  value="27">近两年</li></ul>' +
                    '</div>' +
            ...
            $('[data-role="sure"]').on('click',function () {
                ...
                switch (inputVal){
                    ...
                    case '15'://下年度
                        ...
                        break;
                    case '16'://近三天
                        sTime = moment.moment().subtract(3, 'days').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    case '17'://近十天
                        sTime = moment.moment().subtract(10, 'days').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    case '18'://近十五天
                        sTime = moment.moment().subtract(15, 'days').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;

                    case '19'://近一周
                        sTime = moment.moment().subtract(7, 'days').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    case '20'://近两周
                        sTime = moment.moment().subtract(14, 'days').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    case '21'://近三周
                        sTime = moment.moment().subtract(21, 'days').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;

                    case '22'://近一月
                        sTime = moment.moment().subtract(1, 'month').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    case '23'://近两月
                        sTime = moment.moment().subtract(2, 'month').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    case '24'://近三月
                        sTime = moment.moment().subtract(3, 'month').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;

                    case '25'://近半年
                        sTime = moment.moment().subtract(6, 'month').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    case '26'://近一年
                        sTime = moment.moment().subtract(1, 'year').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    case '27'://近两年
                        sTime = moment.moment().subtract(2, 'year').startOf('day');
                        eTime = moment.moment().startOf('day');
                        break;
                    default:
                        sTime=$('#sTime').val();
...
}).link('/admin/src/style/timepicker.css');